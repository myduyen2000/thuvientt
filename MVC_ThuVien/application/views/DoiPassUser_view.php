...
<div class="w3-main" style="margin-left:250px">
  ...
  <header style="width: 100%;overflow-y: hidden; color: black; margin-bottom: 3vh">
    <div style="height: 10vh;background-color: ;">
        <p class="w3-left"style="color: #2196f3;line-height: 10vh;padding-left: 10px">THƯ VIỆN ONLINE </p>
           ...
           <a href=""> <span style="color: #2196f3;line-height: 10vh;text-align: center;float: right;">Độc Giả <?php echo $userInfor['ten_docgia']; ?></span></a>
 ...
 <div class="a"style="height: 200px;width: 600px;margin-left: 100px;margin-top: 0px;margin-bottom: 200px">
  <p style="text-align: center;">ĐỔI MẬT KHẨU</p>
   <form action="<?php echo base_url(); ?>index.php/User_controller/EditPassUser" method="post" enctype="multipart/form-data"> 
      
        <div class="input-group mb-3" >
 
<?php foreach ($dulieutrave as $key => $value): ?>
  <div class="input-group mb-3" >
  <div class="input-group-prepend" >
    <span class="input-group-text" id="basic-addon1">ID độc giả</span>
  </div>
  <input name="id" type="text" class="form-control"value="<?php echo $value['id_docgia'] ?>" readonly placeholder="" aria-label="username" aria-describedby="basic-addon1">
</div>
...
<div class="input-group mb-3" >
  ...
  <input name="mkc" type="text" class="form-control"value="<?php echo $value['pass'] ?>"readonly placeholder="" aria-label="username" aria-describedby="basic-addon1">
</div>
<?php endforeach ?>
...
<div class="input-group mb-3">
  ...
  <input name="mkm" type="password" class="form-control" placeholder=" " aria-label="username" aria-describedby="basic-addon1">
</div>
...
<div class="input-group mb-3">
  ...
  <input name="cf" type="password" class="form-control" placeholder=" " aria-label="username" aria-describedby="basic-addon1">
</div>
  ...
  <input type="submit"  class="btn btn-primary btn-sm" value="Save"/>
   ...
   <footer class="w3-padding-64 w3-light-grey w3-small w3-center" id="footer"style ="width: 100%;padding-right: 90px;padding-top: 100px;height: ;">
