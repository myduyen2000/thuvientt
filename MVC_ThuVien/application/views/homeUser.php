...
<?php 
    ...
    if(!$CI->session->userdata('docgia')){
      header('Location:http://localhost/MVC_ThuVien/index.php/LoginUser_controller');
      exit();
     }
...
<?php 
    ...
    <a href="<?php echo base_url(); ?>index.php/User_controller/loadthongbao" class="w3-bar-item w3-button"style="color:white;background-color:#2162f3f5!important;margin-bottom: 10px;"> <span class="fa fa-bell">  Thông báo</a>
  ...
  <header style="width: 100%;overflow-y: hidden; color: black; margin-bottom: 3vh">
    <div style="height: 10vh;background-color: ;">
        <p class="w3-left"style="color: #2196f3;line-height: 10vh;padding-left: 10px">THƯ VIỆN ONLINE </p>
           ...
           <a href="<?php echo base_url(); ?>index.php/User_controller/ShowPass_controller/<?php echo $userInfor['id_docgia']; ?>"> <span style="color: #2196f3;line-height: 10vh;text-align: center;float: right;">Độc Giả <?php echo $userInfor['ten_docgia']; ?></span></a>
    ...
    <div class="w3-display-container w3-container">
      <img src="https://scontent.xx.fbcdn.net/v/t1.15752-0/s600x600/181042042_1304505549944329_1007169513424385560_n.jpg?_nc_cat=101&ccb=1-3&_nc_sid=58c789&_nc_ohc=arVcvwFh5RsAX-1-mtH&_nc_ad=z-m&_nc_cid=0&_nc_ht=scontent.xx&tp=7&oh=57e911310f892e2c20c26d1aefccd041&oe=60B602EA" alt="ảnh" style="width:100%;height: 500px">
           ...
           <?php 
            ...
            <div class="col-3 text-center" style="margin-bottom: 5vh">
                <div class="w3-display-container">
                  <a href="<?php echo base_url(); ?>index.php/User_controller/user_chitietsach/<?php echo $value['id_sach'] ?>">
