...
<div class="w3-main" style="margin-left:250px">
  ...
  <header style="width: 100%;overflow-y: hidden; color: black; margin-bottom: 3vh">
    <div style="height: 10vh;background-color: #2162f3f5!important;">
      ...
      <!--  <a href="https://thuviendue.000webhostapp.com/MVC_ThuVien/index.php/LoginController" style = "float: right;font-size: 16px;color: white;text-decoration: none;line-height: 10vh; padding-right: 10px">Login </a> -->
  ...
  <div class="datsach">
    ...
    <table class="table">
     <?php foreach ($traketqua as $key => $value): ?>

      <tbody>
        <tr>
          <th scope="row"><?php echo $i++ ?></th>
          <td> <?php if($value['tinhtrang_muon']==1){echo "Thủ thư đã chấp nhận yêu cầu mượn sách ".$value['tensach'];}else{echo 'Thủ thư không chấp nhận yêu cầu mượn sách '.$value['tensach'];}  ?></td>
