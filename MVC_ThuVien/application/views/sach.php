<!DOCTYPE html>
<html>
<title> Trang quản trị sách </title>
<meta charset="UTF-8">
...
<nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="z-index:3;width:250px;padding-top: 1px;background-color: #9e9e9e38!important;" id="mySidebar">
  ...
  <div class="w3-padding-64 w3-large w3-text-grey" style="font-weight:bold;padding-bottom: 30px;">
    ...
    <a href="<?php echo base_url(); ?>index.php/User_controller/loadthongbao" class="w3-bar-item w3-button"style="color: white;background-color: #2162f3f5!important;margin-bottom: 10px;"><img src="./img/iconthongbao.jpg"style="height: 30px;width: 29px;">  Thông báo</a>
...
<div class="gg">
 ...
 <div class="danhmuctatca"style="margin-top: 100px; ">

     <h2 style="text-align:center">Danh mục tất cả sách</h2>
     </div>
    <div class="w3-container w3-text-grey" id="jeans">
        <p>8 items</p>
    </div>
    
    <div class="sachvv"style ="font-size: 15px">
          ...
          <div class="w3-container">
            <?php foreach ($datacontroller as $key => $value): ?>
                <div class="w3-display-container">
                    <a href="./thong_tin_chi_tiet/kinhtevimo.html"><img src="<?php echo $value['hinhanh'] ?>" style="width: 100px;height: 155.422px"></a>
                    <p><a href="deleteSach_controller/<?php echo $value['id_sach'] ?>">Xoá</a>
                      <a href="showSachEdit_controller/<?php echo $value['id_sach'] ?>">Sửa</a>
                    </p>

                </div>
                <p><?php echo $value['tensach'] ?>
                    <br>
                </p>
                <?php endforeach ?>
            </div>
  ...
  <!-- Footer -->
  <footer class="w3-padding-64 w3-light-grey w3-small w3-center" id="footer"style ="width: 100%;padding-right: 90px;padding-top: 0px;margin-top: 1000px;">
