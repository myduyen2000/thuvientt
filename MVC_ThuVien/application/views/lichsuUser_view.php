      ...
      <div class="w3-display-topleft w3-text-white" style="padding:24px 48px;">
            ...
            <P></P>
                  <table>
                    ...
                    // print_r($dulieu);
                    foreach ($dulieutrave as $key => $value): 

                    ?>
                    <tbody>
                    <tr>
                      <th scope="row"><?php echo $i++ ?></th>
                      <td><?php if($value['tinhtrang_muon']==1){echo "Bạn đã mượn thành công Sách ".$value['tensach'] ;}else{echo 'Bạn đã mượn không thành công Sách '.$value['tensach'];}  ?></td>
