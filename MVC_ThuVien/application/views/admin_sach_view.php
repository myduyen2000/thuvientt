...
<div style="display: flex;width: 100%;">
  <!-- Sidebar/menu -->
  <nav style="flex: 1;width: 20%;padding: 5px"  class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" id="mySidebar">
          <div class="w3-container w3-display-container w3-padding-16"style="padding-left:0px;">
            <i onclick="w3_close()" class="fa fa-remove w3-hide-large w3-button w3-display-topright"></i>
              <a href="http://due.udn.vn/">
                <img src="https://scontent.xx.fbcdn.net/v/t1.15752-9/56815997_549747822214529_236112691771473920_n.png?_nc_cat=108&ccb=1-3&_nc_sid=58c789&_nc_ohc=somwRtseBRMAX8-eRQR&_nc_ad=z-m&_nc_cid=0&_nc_ht=scontent.xx&oh=86821a26efe888a45a0bf5a31ccdcc1b&oe=60B6FEBA"style ="width: 220px;height: 70px;padding-left: 0px">
              </a>
          </div>
          <div class="input-group">
          </div>
          <div class="w3-padding-64 w3-large w3-text-grey" style="font-weight:bold;padding-bottom: 30px;">
            <form action="<?php echo base_url(); ?>index.php/ShowDataSach_controller/searchSach_controller/" method="get"enctype="multipart/form-data">
    <div class="input-group">
      ...
      <button type="submit" class="btn btn-outline-primary"><i class="fa fa-search"></i></button>
           ...
           <form action="<?php echo base_url(); ?>index.php/Admin_Sach_controller/sach" id="books-info" method="post" enctype="multipart/form-data">
            <div class="input-group mb-3">
              <input type="submit" name="iddanhmucs" id="iddanhmuc" type="text"class="btn btn-primary btn-sm" value='DM001' >
            </div>
           </form> 
  ...
  <div style="flex:1;width: 80%;margin-left: 20%;">
      <header style="width: 100%;height: 10vh; color: black;background-color: #2162f3f5!important; margin-bottom: 3vh">
        <p class="w3-left"style="background-color: #2162f3f5!important;color: white;line-height: 10vh;padding-left: 10px">TRANG QUẢN TRỊ  </p>
           ...
           <?php foreach ($data_sach as $key => $value): ?>
            <div class="col-3 text-center" style="margin-bottom: 5vh">
                <div class="w3-display-container">
                  ...
                  <a href="deleteSach_controller/<?php echo $value['id_sach'] ?>">Xoá</a>   
                  <a href="showSachEdit_controller/<?php echo $value['id_sach'] ?>">Sửa</a>
                </div>
            </div>
          <?php endforeach ?>
         </div>
