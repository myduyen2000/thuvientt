...
<body class="w3-content" style="max-width:1200px;">
  ...
  <a href="<?php echo base_url(); ?>index.php/User_controller/cart" class="w3-bar-item w3-button w3-padding"style="color: #2162f3f5!important;font-size: 18px">cart</a> 
   ...
   <a href="<?php echo base_url(); ?>index.php/Lichsu_controller/showLichsuUser0/<?php echo $userInfor['id_docgia']; ?>" class="w3-bar-item w3-button w3-padding"style="color: #2162f3f5!important;font-size: 18px;padding-top: 0px;">Lịch sử đặt sách </a>
...
<div class="w3-main" style="margin-left:250px">
  ...
  <header style="width: 100%;overflow-y: hidden; color: black; margin-bottom: 3vh">
    <div style="height: 10vh;background-color: #2162f3f5!important;">
      ...
      <!-- <a href="loginController" style = "float: right;font-size: 16px;color: white;text-decoration: none;line-height: 10vh; padding-right: 10px">Login </a> -->
   ...
   <!--  <div class="w3-display-container w3-container">
      ...
      <div class="w3-display-topleft w3-text-white" style="padding:24px 48px;">
                ...
                <div class="datsach">
                  ...
                  <form action="<?php echo base_url(); ?>index.php/User_controller/insertMuon/<?php echo count($mangketqua) ?>"method="post" enctype="multipart/form-data">
                    <?php 
                    ...
                    <div class="input-group mb-3">
                     ...
                     <input  name="idsach<?php echo $i ?>" id="tensach" type="text" class="form-control" placeholder="" aria-label="nhập tên sách" aria-describedby="basic-addon1"Readonly=''value='<?php echo($value->getIdSach()) ?>'>
                     <span class="input-group-text" id="basic-addon1"style="margin-left: 200px">Số lượng</span>
                     <input name="soluong<?php echo $i ?>" id="soluong" type="number"min='1' value="1" class="form-control" placeholder="" aria-label="nhập tên sách" aria-describedby="basic-addon1">
                    </div>
                    <div class="input-group mb-3">
                      <div class="input-group-prepend">
                       <span class="input-group-text" id="basic-addon1">Tên sách</span>
                     </div>
                     <input name="tensach<?php echo $i ?>" id="tensach" type="text" class="form-control" placeholder="" aria-label="nhập tên sách" aria-describedby="basic-addon1"Readonly=''value='<?php echo($value->getTenSach()) ?>'>
                    </div>
                    ...
                    <?php $i++; endforeach ?>
                      ...
                      <div class="input-group mb-3">
                      <div class="input-group-prepend">
                       <span class="input-group-text" id="basic-addon1">id doc gia </span>
                     </div>
                     <input name="iddocgia" id="tensach" type="text" class="form-control" placeholder="" aria-label="nhập tên sách" aria-describedby="basic-addon1"Readonly=''value='<?php echo $userInfor['id_docgia']; ?>'>
                    </div>
                   <a href=""><button type="submit" class="btn"style= "background-color: #2162f3f5">Save</button></a> 
             </form>
              </div>
            </div>
