...
<body class="w3-content" style="max-width:1200px;">
  ...
  <div class="w3-padding-64 w3-large w3-text-grey" style="font-weight:bold;padding-bottom: 30px;">
      <form action="<?php echo base_url(); ?>index.php/ShowDataSach_controller/searchDocgia_controller/" method="get"enctype="multipart/form-data">
    <div class="input-group">
...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="a"style="height: ;width: 600px;margin-left: 100px;margin-top: 100px">
    ...
    <table class="table">
      ...
      <tbody>
         ...
         <?php foreach ($docgia as $key => $value): ?>
        <tr>
          <td><?php echo $i++ ?></td>
         <td><?php echo $value['id_docgia'] ?></td>
         <td><?php echo $value['pass'] ?></td>
          <td><?php echo $value['ten_docgia'] ?></td>
          <td><?php echo $value['donvi_docgia'] ?></td>
          <td><?php echo $value['ngaylamthe_docgia'] ?></td>
          <td>
            <a href="<?php echo base_url(); ?>index.php/Docgia_controller/deleteDocgia_controller/<?php echo $value['id_docgia'] ?>">Xoá</a>
            <a href="<?php echo base_url(); ?>index.php/Docgia_controller/showDocgia_edit_controller/<?php echo $value['id_docgia'] ?>">Sửa</a>
          </td>
        </tr>
        <?php endforeach ?>
