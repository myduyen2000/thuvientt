...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-display-container w3-container">
    <img src="http://due.udn.vn/Portals/0/Banner Truong/tvts_2021.jpg" alt="Jeans" style="width:100%;height: 500px">
    <div class="w3-display-topleft w3-text-white" style="padding:24px 48px;">
     <!--  <h1 class="w3-jumbo w3-hide-small">Sách hay  </h1>
      <h1 class="w3-hide-large w3-hide-medium">Sách hay</h1>
      <h1 class="w3-hide-small">MỖI TUẦN</h1>
      <p><a href="#jeans" class="w3-button w3-black w3-padding-large w3-large">XEM NGAY</a></p> -->
    </div>
  </div>
  <div>
            <div style="margin-top: 20px;padding-left: 30px">
                <h4>THÔNG BÁO</h4>
                <div class="tintuc" style="display: flex;">
                    <div class="anh">
                        <a href="thongbao1.html">
                            <!-- 
                              <img src="./img/so1.jpg"style ="width: 100px;height: 56px;margin-right: 20px;"> -->
                        </a>
                    </div>
                    <div class="thongtin">
                        <a href="thongbao1.html"style="color: #2162f3f5!important;text-decoration: none">
                             THÔNG BÁO: VỀ VIỆC MƯỢN SÁCH GIÁO TRÌNH HỌC KÌ I, NĂM HỌC 2020 - 2021 CHO KHÓA 46K
                        </a>
                        <p style ="font-size: 12px;font-weight: bold;"  >Thư viện trường Đại học Kinh tế Đà Nẵng thông báo: Từ thứ 2, ngày 09/11/2020, sinh viên khóa 46K được mượn sách Giáo trình tại tầng 2, Thư viện Nhà trường (gần KTX). Khi đến mượn sách tại Thư viện, yêu cầu sinh viên mang theo CMND và mã Sinh viên. Thời gian mượn đối với sách Giáo trình là 70 ngày ...</p>
                ...
                <div style="display: flex;">
                    <div  >
                        <a href="thongbao2.html">
                            <!-- <img src="./img/anh2.jpg"style ="width: 100px;height: 56px;margin-right: 20px;"> -->
                        </a>
                    </div>
                    <div>
                        <a href="thongbao2.html" style="color: #2162f3f5!important;text-decoration: none"> THÔNG BÁO: VỀ VIỆC MƯỢN TÀI LIỆU GIÁO TRÌNH HỌC KÌ I, NĂM HỌC 2020-2021</a>
                ...
                <div style="display: flex;">
                    <div>
                        <a href="tbao3.html">
                            <!-- <img src="./img/tbao5.jpg"style ="width: 100px;height: 56px;margin-right: 20px;"> -->
                        </a>
                    </div>
                    <div>
                        <a href="tbao3.html" style="color: #2162f3f5!important;text-decoration: none"> THÔNG BÁO: VỀ VIỆC THAY ĐỔI ĐỊA ĐIỂM GIAO DỊCH TÀI LIỆU</a>
                        <p style ="font-size: 12px;font-weight: bold;">Thư viện trường Đại học kinh tế thông báo: Từ ngày 18/05/2020...</p>
                ...
                <div style="display: flex;">
                    <div>
                        <a href="tbao4.html">
                            <!-- <img src="./img/tbao4.jpg"style ="width: 100px;height: 56px;margin-right: 20px;"> -->
                        </a>
                    </div>
                    <div>
                        <a href="tbao4.html" style="color: #2162f3f5!important;text-decoration: none"> THÔNG BÁO: VỀ VIỆC TRẢ SÁCH TẠI KHO GIÁO TRÌNH – TẦNG 1 KHU C</a>
                        <p style ="font-size: 12px;font-weight: bold;">Nhằm quản lý và tạo điều kiện thuận lợi cho sinh viên, Thư viện trường Đại học kinh tế thông báo hướng dẫn cho sinh viên các khóa cách thức trả sách mới...
