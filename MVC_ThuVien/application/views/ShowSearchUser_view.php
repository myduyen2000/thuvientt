    ...
    <table class="table">
      <thead class="thead-dark">
        <tr>
          ...
          <th scope="col">Số trang sách</th>
          <th scope="col">Tên tác giả</th>
          <th scope="col">Thời gian được mượn</th>
         ...
         <td><?php echo $value['id_danhmuc'] ?></td>
          ...
          <td><?php echo $value['thoigianxuatban'] ?></td>
           ...
           <?php 
                   ...
                   ?>
          <td><a href="<?php echo base_url(); ?>index.php/User_controller/addGiohang_controller/<?php echo $dataCart->getIdSach() ?>" >add cart</a></td>
